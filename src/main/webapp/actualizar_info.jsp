...
<html>
	...
	<body>
		...
		<main class='centrar_profile'>
			<section class='dividir_pantalla'>
				<button onclick="window.location.href = 'actualizar_suministros.jsp';">Actualizar Suministros</button>
				<img class='icono' alt="" src="resources/suministros.png">
			</section>
			<section class='dividir_pantalla'>
				<button onclick="window.location.href = 'actualizar_estado.jsp';">Actualizar Estado de Donaciones</button>
				<img class='icono' alt="" src="resources/recursos.png">
			</section>
		</main>
		<footer>
