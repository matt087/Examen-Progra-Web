...
<html>
	...
	<body>
		...
		<main class='centrar_vertical'>
			<form id="registro_fundaciones" action="respuesta_registro_donacion.jsp" method="post" class='form_funda'>
		        <fieldset class='field'>
		            <h2>Registro de Donaciones</h2>
		            	<label class="label2">Nombre de la Fundacion: </label>
						<%
							Fundacion fun = new Fundacion();
							out.print(fun.comboFundaciones());
						%>		            
       		        <div class="envio2">
