...
<html>
	<head>
		...
		<title>Suministros de la Fundación</title>
	</head>
	<body>
		...
		<main class='centrar_profile'>
			<form id="registro" action="respuesta_registrar_sum.jsp" method="post" class='centrado_form'>
		        <fieldset>
		            <h2>Registro de Suministros</h2>
		            	<label class="label">Nombre del Suministro: </label>
